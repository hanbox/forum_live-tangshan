...
patterns = [
    url('^$', views.friendslist, name='friends_list'), 
    url('^deletefriend', views.deletefriend, name='friends_list'),
    url('^start_chat', views.start_chat, name='start_chat'), 
    ...
    url('^(?P<chat_uuid>[\w-]+)/(?P<talkto>[\w-]+)/$', views.client_chat, name='client_chat'),
]


urlpatterns = [
    url(r'^', include(patterns, namespace='chat', app_name='chat')),
]
